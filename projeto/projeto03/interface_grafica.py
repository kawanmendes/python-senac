...
# Botões do menu
botao1 = ctk.CTkButton(janela, text="Home", command=botao_menu)
botao1.pack(pady=10, padx=10)

botao2 = ctk.CTkButton(janela, text="Configurações", command=configuracoes)
botao2.pack(pady=10, padx=10)

botao3 = ctk.CTkButton(janela, text="Sobre", command=sobre)
