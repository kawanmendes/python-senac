...
jogador4 = jogador('joao', 'goleiro', 23)
time1.adicionar_jogador(jogador4)
jogador5 = jogador('ana', 'lateral', 19)
time1.adicionar_jogador(jogador5)
jogador6 = jogador('pedro', 'volante', 24)
time1.adicionar_jogador(jogador6)
jogador7 = jogador('carla', 'atacante', 20)
time1.adicionar_jogador(jogador7)


print(time1)
print(f'o total de jogadores e: {time1.total_jogadores(time1.jogadores)}')
time1.lista_jogadores(time1.jogadores)
print(f'a media de idades e: {time1.media_idades():.2f}')