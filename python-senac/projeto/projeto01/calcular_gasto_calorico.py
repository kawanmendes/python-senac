...
# Função principal para calcular o gasto calórico baseado no MET, peso e tempo de treino
# Recebe o MET do exercício, solicita peso e tempo ao usuário, calcula e exibe calorias queimadas
...
# Função para exibir opções de treino e chamar o cálculo correspondente
def opcoes_de_treino():
...
# Executa o menu de opções de treino
opcoes_de_treino()
