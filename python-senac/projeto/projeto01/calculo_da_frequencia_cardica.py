...
# Função para calcular frequência cardíaca máxima e zonas de treino
# Solicita idade ao usuário, calcula e exibe zonas de queima de gordura e cardio
def frequencia_cardiaca():
    ...
    print(f"Sua zona cardio é entre: {zona_cardio1} e {zona_cardio2} bpm")
